...
import { Simplex, Turbulence } from "../../src";

const G2 = (3 - Math.sqrt(3)) / 6;

describe(Turbulence.name, () => {
  const noise = new Turbulence(new Simplex("test-seed"), 4, 2, 0.5);
  ...
  describe("noise1", () => {
    ...
    it("should generate consistent noise values for the same seed", () => {
      const noise2 = new Turbulence(new Simplex("test-seed"), 4, 2, 0.5);
      const value1 = noise.noise1(0.5);
  ...
  describe("noise4", () => {
    ...
    it("should generate zero values at the origin", () => {
